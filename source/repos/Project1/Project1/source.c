...
#pragma region 문자열
	...
	//수 있으며, 문자열 상수는 데이터 영역의 읽기 전용 ㅗㅇ간에 저장
	...
	//문자열은 공백도 함께 메모리 공간에 포함하여 크키가 결정되며,
	...
	// 문자열의 경우 서로 연속적인 메모리 공간으로 연걸되어 있지만,
...
#pragma region (2)차원 배열
	...
	// 2차원 배열은 행과 열로 구분되며, 앞에 있느 배열은
	// 열을 의마하고, 뒤에 있는 배열은 행을 의미합니다.
