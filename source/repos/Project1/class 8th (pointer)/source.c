...
#pragma region 주소연산자
	...
	// 의미하며, 메모리의 공간은 1byte의 크기로 나누어 표현합니다.
#pragma endregion
...
//	printf("pointer 변수의 크기 : %u\n", sizeof(pointer));
	...
	// 크키로 정해지며, 한 번에 처리할 수 있는 크기는 운영체재에 따라 크기가 결정됩니다.
...
#pragma region 포인터 상수
	...
	*fixedreference = 99;
	...
	printf("fixedreference가 가리키는값 : %d\n", *fixedreference);
